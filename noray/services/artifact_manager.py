...
class ArtifactManager:
    ...
    def get_artifact(self, session_id: str, category: str) -> dict[str, Any] | None:
        """Returns the latest version of the target artifact category for the session."""
        artifact_id = f"{session_id}:{category}"
        return self.cache.get(artifact_id)

    def get_artifact_version(self, session_id: str, category: str, version: int) -> dict[str, Any] | None:
